		...
		<table class="table  lg-8">
			...
			<tr>
				...
				<td><input type="text" name="nombre" required
					placeholder="Nombre" class="form-control"></td>
			</tr>

			<tr>
				<td>Apellido Paterno:</td>
				<td><input type="text" name="apePat" required
					placeholder="Apellido paterno" class="form-control"></td>
			</tr>

			<tr>
				<td>Apellido Materno:</td>
				<td><input type="text" name="apeMat" required
					placeholder="Apellido materno" class="form-control"></td>
			</tr>

			<tr>
				<td>Correo electronico:</td>
				<td><input type="text" name="email" required
					placeholder="Correo electrónico" class="form-control"></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="telefono" required
					placeholder="Teléfono" class="form-control"></td>
			</tr>
			...
			<tr>
				<td><input type="text" name="delegacion" class="form-control"
					placeholder="Delegación" required></td>
				<td><input type="text" name="colonia" class="form-control"
					placeholder="Colonia" required></td>
			...
			<tr>
				<td><input type="number" name="numInt" class="form-control"
					placeholder="Número interior"></td>
