...
<body>
	...
	<div class="container text-center">
		...
		<p>Se le enviará un correo con su usario y contraseña al
			repartidor</p>
	</div>
		...
		<div
			...
			<div class=" form-group">
				<label for="nombre">Nombre</label> <input type="text"
					class="form-control" name="nombre" id="nombreRepartidor"
					placeholder="Escribe el/los nombres del repartidor" required>
			</div>
