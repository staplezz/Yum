	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "registrarRepartidor":
				System.out.println("yendo a p�gina de registro");
		...
		private void showRegistroRepartidor(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException{
			RequestDispatcher dispatcher= request.getRequestDispatcher("/jsp/AdminRepartidor/RegistroRepartidorIH.jsp");
		...
		private void mostrar(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException , ServletException{
			RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/AdminRepartidor/RepartidorAdminIH.jsp");
		...
		private void showEditorRepartidor(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/AdminRepartidor/EditorRepartidorIH.jsp");
			dispatcher.forward(request, response);
		}
		...
		private void buscarRepartidores(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException{
			RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/AdminRepartidor/BusquedaRepartidor.jsp");
