			...
			<div class= "col-sm-8 col-md-8 col-lg-8  offset-sm-2 offset-md-2 offset-lg-2">
				<form action="modificadorCliente?action=editarDireccion&idDireccion=<c:out value='${direccion.getIdDireccion()}'/>"  method="post"> 
					<table class="table w-55  lg-8">
						...
						<tr>
							<td>
								<input type="text" name="delegacion"  class="form-control" placeholder="Delegación" value = "<c:out value="${direccion.getDelegacion()}"></c:out>" required >
							</td>
							<td>
						...
						<tr>
							<td>
								<input type="number" name="numInt" class="form-control" placeholder="Número interior" value = "<c:out value="${direccion.getNumInterior()}"></c:out>" > 
							</td>
							<td>
								<input type="number" name="numExt" class="form-control"  placeholder="Número exterior" value = "<c:out value="${direccion.getNumExterior()}"></c:out>" >
							</td>
						</tr>
